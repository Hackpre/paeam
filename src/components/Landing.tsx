  ...
  const features = [
    {
      ...
      description: 'Verified profiles with legal identity, association membership, and digital certificates. Every producer is authenticated and recognized by PAEAM.',
      color: 'gold',
    },
    {
      icon: <Disc3 size={24} />,
      title: 'Secure Catalog',
      description: 'Register every song with full metadata — ISRC codes, BPM, key, split sheets, and publishing details. Your creative work, permanently documented.',
      color: 'blue',
    },
    {
      icon: <FileText size={24} />,
      title: 'Contract & Royalty Management',
      description: 'Exclusive, non-exclusive, and work-for-hire agreements with detailed royalty splits — mechanical, performance, and publishing rights tracked precisely.',
      color: 'amber',
    },
    {
      icon: <Lock size={24} />,
      title: 'Three-Way Lock System',
      description: 'Records become immutable once approved by the Producer, Artist, and Association Witness. No one — including backend admins — can alter locked records.',
      color: 'rose',
    },
    {
      icon: <Fingerprint size={24} />,
      title: 'Cryptographic Verification',
      description: 'SHA-256 content hashing on every locked record. Tamper-evident audit trail ensures legal proof of creation dates and ownership.',
      color: 'gold',
    },
    {
      icon: <Scale size={24} />,
      title: 'Legal Protection',
      description: 'Timestamp certificates, creation date proof, and Producer Registration IDs. Built to serve as evidence in court and strengthen producer rights in Malawi.',
      color: 'orange',
    },
  ];
          ...
          <div className="bg-gradient-to-br from-neutral-900 to-neutral-800 border border-neutral-700 rounded-3xl p-8 sm:p-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
              <div className="bg-neutral-800/50 border border-gold-500/20 rounded-2xl p-6 text-center">
                ...
                <p className="text-sm text-neutral-400">Initiates the lock and provides digital signature with SHA-256 hash</p>
              </div>
              <div className="bg-neutral-800/50 border border-blue-500/20 rounded-2xl p-6 text-center">
                <div className="w-14 h-14 rounded-2xl bg-blue-500/10 flex items-center justify-center mx-auto mb-4">
                  <Music size={28} className="text-blue-400" />
                </div>
                <h3 className="font-semibold text-white mb-2">Artist</h3>
                <p className="text-sm text-neutral-400">Confirms agreement terms and co-signs the record with cryptographic proof</p>
              </div>
              <div className="bg-neutral-800/50 border border-amber-500/20 rounded-2xl p-6 text-center">
                <div className="w-14 h-14 rounded-2xl bg-amber-500/10 flex items-center justify-center mx-auto mb-4">
                  <Shield size={28} className="text-amber-400" />
                </div>
                <h3 className="font-semibold text-white mb-2">Association Witness</h3>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-neutral-400">
              ...
              <span className="flex items-center gap-2"><CheckCircle2 size={16} className="text-gold-400" /> Version-controlled</span>
              <span className="flex items-center gap-2"><CheckCircle2 size={16} className="text-gold-400" /> Court-admissible</span>
            </div>
          </div>
        </div>
      </section>
